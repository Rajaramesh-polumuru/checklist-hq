...
import { Loading02Icon, Delete02Icon, Clock01Icon, RefreshIcon, SecurityCheckIcon, CheckmarkCircle01Icon } from '@hugeicons/core-free-icons'
...
export function RetentionSettings({ organizationId }: { organizationId: string }) {
  ...
  return (
    <div className="space-y-4">
      ...
      {/* ── last run notice ─────────────────── */}
      {lastClean && (
        <div className="text-xs text-green-700 bg-green-50 border border-green-200 rounded-lg px-3 py-1.5 flex items-center gap-1.5 w-fit">
